...
<form style="margin-left: 30%;" method="post">
    <div class="personal">
        <label class="form-label-radio">
            <input type="radio" value="1" checked="" <?=$print_ad[ 'privat']==1 ? 'checked' : '' ?> name="privat">Частное лицо</label>
        <label class="form-label-radio">
            <input type="radio" value="2" <?=$print_ad[ 'privat']==2 ? 'checked' : '' ?> name="privat">Компания
        </label>
    </div>
    <div class="name">
        <label for="fld_seller_name"><b id="your-name">Ваше имя </b></label>
        <input type="text" maxlength="40" value="<?php echo $print_ad[seller_name] ?>" name="seller_name" id="fld_seller_name">
    </div>
    <div class="email">
        <label for="fld_email">Электронная почта</label>
        <input type="text" value="<?php echo $print_ad[email] ?>" name="email" id="fld_email">
    </div>
    <div class="allow-mails">
        <label for="allow_mails">
            <input type="checkbox" value="checked" <?php echo $print_ad[allow_mails] ?> name="allow_mails" id="allow_mails"><span>Я не хочу получать вопросы по объявлению по e-mail</span>
        </label>
    </div>
    <div class="phone">
        <label id="fld_phone_label" for="fld_phone">Номер телефона</label>
        <input type="text" value="<?php echo $print_ad[phone] ?>" name="phone" id="fld_phone">
    </div>
    ...
    <div id="f_title">
        ...
        <input type="text" maxlength="50" value="<?php echo $print_ad[title] ?>" name="title" id="fld_title">
    </div>
    <div class="description">
        <label for="fld_description" id="js-description-label">Описание объявления</label>
        <br>
        <textarea name="description" cols="80" rows="5" maxlength="3000" id="fld_description">
            <?php echo $print_ad[description] ?>
        </textarea>
    </div>
    <div id="price_rw">
